...
const BlogCategoryPage: React.FC = () => {
  const [, params] = useRoute('/blog/categoria/:slug');
  ...
  const {
    ...
    queryKey: ['/api/blog/categories/slug', categorySlug],
      ...
      <MainLayout>
        <div className="container mx-auto py-16 text-center">
          ...
          <p className="text-muted-foreground mb-8">
            A categoria que você está procurando pode ter sido removida ou não existe.
          </p>
          <Link href="/blog">
            <Button>
  ...
  return (
    <MainLayout>
      {/* SEO Tags */}
      <Helmet>
        <title>{category.metaTitle || `Artigos sobre ${category.name}`} | ConectaWorking Blog</title>
        <meta 
          name="description" 
          content={category.metaDescription || `Confira nossos artigos, tutoriais e dicas sobre ${category.name} para arquitetos e designers de interiores.`} 
        />
        <meta property="og:title" content={category.metaTitle || `Artigos sobre ${category.name}`} />
        <meta 
          property="og:description" 
          content={category.metaDescription || `Confira nossos artigos, tutoriais e dicas sobre ${category.name} para arquitetos e designers de interiores.`} 
        />
        {category.featuredImage && <meta property="og:image" content={category.featuredImage} />}
        ...
        {error ? (
          ...
          <div className="text-center py-12">
            <p className="text-xl text-muted-foreground">
              Nenhum artigo encontrado para a categoria {category.name}
